    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BookModel>().HasData(
                ...
                //new BookModel { ItemId = 4, Author = "Author4", Title = "Title4", Category = "Category1", ISBN = "ISBN4", CurrentLoanId = 219, Condition = Condition.OK, Reservations = new List<int> { 3 }, AvgRating = 3.33333333333333 },
                //new BookModel { ItemId = 5, Author = "Author5", Title = "Title5", Category = "Category2", ISBN = "ISBN5", CurrentLoanId = 0, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 4 },
                ...
                //new BookModel { ItemId = 12, Author = "Johann", Title = "Item12", Category = "Category12", ISBN = "string", CurrentLoanId = 0, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 2.75 },
                //new BookModel { ItemId = 23, Author = "Marion", Title = "ABC", Category = "Kinder", ISBN = "2345", CurrentLoanId = 0, Condition = Condition.OK, Reservations = new List<int>(), AvgRating = 3.4 },
                //new BookModel { ItemId = 24, Author = "Marion", Title = "Biene Maja", Category = "Kinder", ISBN = "2345", CurrentLoanId = 217, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 3.75 },
                //new BookModel { ItemId = 25, Author = "A1", Title = "TestReservation1", Category = "C1", ISBN = "3456", CurrentLoanId = 216, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 3 },
                //new BookModel { ItemId = 26, Author = "A2", Title = "TestReservation2", Category = "C2", ISBN = "4567", CurrentLoanId = 0, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 1.66666666666667 },
                //new BookModel { ItemId = 27, Author = "A3", Title = "TestReservation3", Category = "C3", ISBN = "5678", CurrentLoanId = 0, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 3 },
                //new BookModel { ItemId = 28, Author = "A4", Title = "TestReservation4", Category = "C4", ISBN = "6789", CurrentLoanId = 0, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 2 },
                //new BookModel { ItemId = 29, Author = "Else Müller", Title = "Heidi", Category = "Kinder", ISBN = "84654e856", CurrentLoanId = 0, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 4.5 },
                //new BookModel { ItemId = 30, Author = "F. Scott Fitzgerald", Title = "The Great Gatsby", Category = "Roman", ISBN = "25472683", CurrentLoanId = 0, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 4.5 },
                //new BookModel { ItemId = 31, Author = "Arthur Miller", Title = "Hexenjagd", Category = "Tragödie", ISBN = "459174365", CurrentLoanId = 0, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 4 },
                //new BookModel { ItemId = 32, Author = "Schreiberling", Title = "Peter Pan", Category = "Kinder", ISBN = "476547", CurrentLoanId = 0, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 4 },
                //new BookModel { ItemId = 33, Author = "Bundestag", Title = "BGB", Category = "Gesetzestext", ISBN = "2345678", CurrentLoanId = 0, Condition = Condition.OK, Reservations = new List<int> { 1 }, AvgRating = 5 },
                //new BookModel { ItemId = 34, Author = "Gebrüder Grimm", Title = "Hänsel und Gretel", Category = "Märchen", ISBN = "829374", CurrentLoanId = 0, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 2.5 },
                //new BookModel { ItemId = 35, Author = "Karl Marx", Title = "Das Kapital. Band I", Category = "Wirtschaft", ISBN = "84375918347", CurrentLoanId = 0, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 2.33333333333333 },
                //new BookModel { ItemId = 36, Author = "Georg Büchner", Title = "Dantons Tod", Category = "Drama", ISBN = "7985123460", CurrentLoanId = 0, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 0 },
                ...
                //new BookModel { ItemId = 46, Author = "Stephen King", Title = "Es", Category = "Horror", ISBN = "676767867867", CurrentLoanId = 0, Condition = Condition.New, Reservations = new List<int>(), AvgRating = 1 },
                //new BookModel { ItemId = 52, Author = "1111", Title = "TestReturnItem", Category = "1111", ISBN = "1111", CurrentLoanId = 0, Condition = Condition.OK, Reservations = new List<int> { 1 }, AvgRating = 3.33333333333333 }
               );
            ...
            modelBuilder.Entity<MessageModel>().HasData(
                ...
                //new MessageModel { MessageId = 1, SenderId = 1, ReceiverId = 5, Date = new DateTime(2021, 1, 15), Text = "Text", Type = MessageType.ExtensionRequest, Payload = "Payload" },
                //new MessageModel { MessageId = 2, SenderId = 5, ReceiverId = 1, Date = new DateTime(2021, 1, 16), Text = "Text", Type = MessageType.Unknown, Payload = "Payload" },
                //new MessageModel { MessageId = 3, SenderId = 1, ReceiverId = 4, Date = new DateTime(2021, 1, 1), Text = "Text", Type = MessageType.Unknown, Payload = "Payload" },
                //new MessageModel { MessageId = 4, SenderId = 4, ReceiverId = 1, Date = new DateTime(2021, 1, 2), Text = "Text", Type = MessageType.Unknown, Payload = "Payload" },
                //new MessageModel { MessageId = 5, SenderId = 0, ReceiverId = 0, Date = new DateTime(2021, 1, 3), Text = "Text", Type = MessageType.Unknown, Payload = "Payload" },
                //new MessageModel { MessageId = 6, SenderId = 1, ReceiverId = 5, Date = new DateTime(2021, 1, 4), Text = "Text", Type = MessageType.Unknown, Payload = "Payload" },
                //new MessageModel { MessageId = 7, SenderId = 0, ReceiverId = 1, Date = new DateTime(2021, 1, 5), Text = "Text", Type = MessageType.Unknown, Payload = "Payload" },
                //new MessageModel { MessageId = 244, SenderId = 0, ReceiverId = 0, Date = new DateTime(2024, 5, 21, 12, 53, 24), Text = "Der Artikel Mühle wurde zum Katalog hinzugefügt", Type = MessageType.Unknown, Payload = "Mühle" },
                //new MessageModel { MessageId = 263, SenderId = 0, ReceiverId = 0, Date = new DateTime(2024, 5, 21, 13, 19, 41), Text = "Der Artikel Vogue wurde zum Katalog hinzugefügt", Type = MessageType.Unknown, Payload = "Vogue" },
                //new MessageModel { MessageId = 285, SenderId = 13, ReceiverId = 4, Date = new DateTime(2024, 5, 21, 13, 40, 27), Text = "lissi@email.com hat eine Zurücksetzung des Passworts angefragt", Type = MessageType.PasswordResetRequest, Payload = "lissi@email.com" },
                //new MessageModel { MessageId = 291, SenderId = 19, ReceiverId = 4, Date = new DateTime(2024, 5, 21, 14, 44, 7), Text = "lissi hat sich registriert", Type = MessageType.Registration, Payload = "NULL" },
                //new MessageModel { MessageId = 292, SenderId = 20, ReceiverId = 4, Date = new DateTime(2024, 6, 3, 8, 34, 59), Text = "Delete hat sich registriert", Type = MessageType.Registration, Payload = "NULL" },
                //new MessageModel { MessageId = 293, SenderId = 21, ReceiverId = 4, Date = new DateTime(2024, 6, 3, 8, 39, 32), Text = "deleteAccount hat sich registriert", Type = MessageType.Registration, Payload = "NULL" },
                //new MessageModel { MessageId = 294, SenderId = 0, ReceiverId = 1, Date = new DateTime(2024, 6, 3, 8, 57, 29), Text = "Title2 ist seit 399 Tagen überfällig", Type = MessageType.OverdueNotice, Payload = "4" },
                //new MessageModel { MessageId = 295, SenderId = 0, ReceiverId = 5, Date = new DateTime(2024, 6, 3, 8, 58, 35), Text = "user2 hat Title9 seit 399 Tagen überfällig", Type = MessageType.OverdueNotice, Payload = "9" },
                //new MessageModel { MessageId = 296, SenderId = 0, ReceiverId = 5, Date = new DateTime(2024, 6, 3, 8, 58, 35), Text = "user1 hat Title2 seit 399 Tagen überfällig", Type = MessageType.OverdueNotice, Payload = "4" },
                //new MessageModel { MessageId = 297, SenderId = 0, ReceiverId = 5, Date = new DateTime(2024, 6, 3, 8, 58, 35), Text = "user2 hat Title3 seit 399 Tagen überfällig", Type = MessageType.OverdueNotice, Payload = "5" },
                ...
                //new MessageModel { MessageId = 299, SenderId = 0, ReceiverId = 1, Date = new DateTime(2024, 6, 3, 11, 37, 56), Text = "Vogue ist in 2 Tagen fällig", Type = MessageType.DueReminder, Payload = "102" },
                ...
                //new MessageModel { MessageId = 302, SenderId = 0, ReceiverId = 2, Date = new DateTime(2024, 6, 3, 13, 33, 0), Text = "Der von Ihnen reservierte Artikel Title8 ist jetzt verfügbar", Type = MessageType.ReservationAvailable, Payload = "8" },
                //new MessageModel { MessageId = 303, SenderId = 0, ReceiverId = 2, Date = new DateTime(2024, 6, 3, 13, 33, 28), Text = "Title3 ist seit 399 Tagen überfällig", Type = MessageType.OverdueNotice, Payload = "5" },
                //new MessageModel { MessageId = 304, SenderId = 0, ReceiverId = 2, Date = new DateTime(2024, 6, 3, 13, 33, 28), Text = "Title9 ist seit 399 Tagen überfällig", Type = MessageType.OverdueNotice, Payload = "9" },
                //new MessageModel { MessageId = 305, SenderId = 0, ReceiverId = 2, Date = new DateTime(2024, 6, 3, 13, 39, 27), Text = "TestReservation4 ist in 3 Tagen fällig", Type = MessageType.DueReminder, Payload = "104" },
                //new MessageModel { MessageId = 306, SenderId = 0, ReceiverId = 2, Date = new DateTime(2024, 6, 3, 13, 52, 44), Text = "Vogue ist in 3 Tagen fällig", Type = MessageType.DueReminder, Payload = "105" },
                //new MessageModel { MessageId = 307, SenderId = 0, ReceiverId = 17, Date = new DateTime(2024, 6, 3, 14, 4, 5), Text = "Vogue ist in 3 Tagen fällig", Type = MessageType.DueReminder, Payload = "109" },
                //new MessageModel { MessageId = 308, SenderId = 0, ReceiverId = 17, Date = new DateTime(2024, 6, 4, 6, 46, 6), Text = "Vogue ist in 2 Tagen fällig", Type = MessageType.DueReminder, Payload = "110" },
                ...
                //new MessageModel { MessageId = 310, SenderId = 0, ReceiverId = 3, Date = new DateTime(2024, 6, 4, 7, 16, 58), Text = "Der von Ihnen reservierte Artikel Title2 ist jetzt verfügbar", Type = MessageType.ReservationAvailable, Payload = "2" },
                //new MessageModel { MessageId = 311, SenderId = 0, ReceiverId = 2, Date = new DateTime(2024, 6, 4, 7, 19, 22), Text = "TestReservation1 ist in 3 Tagen fällig", Type = MessageType.DueReminder, Payload = "113" },
                ...
                //new MessageModel { MessageId = 316, SenderId = 0, ReceiverId = 1, Date = new DateTime(2024, 6, 4, 7, 36, 24), Text = "Vogue ist in 2 Tagen fällig", Type = MessageType.DueReminder, Payload = "118" },
                ...
                //new MessageModel { MessageId = 318, SenderId = 0, ReceiverId = 2, Date = new DateTime(2024, 6, 4, 8, 53, 55), Text = "Der von Ihnen reservierte Artikel TestReservation3 ist jetzt verfügbar", Type = MessageType.ReservationAvailable, Payload = "27" },
                //new MessageModel { MessageId = 319, SenderId = 0, ReceiverId = 2, Date = new DateTime(2024, 6, 4, 8, 54, 21), Text = "Der von Ihnen reservierte Artikel TestReservation4 ist jetzt verfügbar", Type = MessageType.ReservationAvailable, Payload = "28" },
                ...
                //new MessageModel { MessageId = 323, SenderId = 0, ReceiverId = 0, Date = new DateTime(2024, 6, 4, 11, 22, 39), Text = "Der Artikel Supernatural Evangelium wurde zum Katalog hinzugefügt", Type = MessageType.Unknown, Payload = "Supernatural Evangelium" },
                //new MessageModel { MessageId = 324, SenderId = 22, ReceiverId = 4, Date = new DateTime(2024, 6, 4, 11, 51, 37), Text = "tano@email.com hat eine Zurücksetzung des Passworts angefragt", Type = MessageType.PasswordResetRequest, Payload = "tano@email.com" },
                ...
                //new MessageModel { MessageId = 328, SenderId = 0, ReceiverId = 0, Date = new DateTime(2024, 6, 5, 9, 29, 58), Text = "Der Artikel Es wurde zum Katalog hinzugefügt", Type = MessageType.Unknown, Payload = "Es" },
                //new MessageModel { MessageId = 329, SenderId = 0, ReceiverId = 0, Date = new DateTime(2024, 6, 5, 10, 53, 53), Text = "Der Artikel Mensch-ärger-dich-nicht wurde zum Katalog hinzugefügt", Type = MessageType.Unknown, Payload = "Mensch-ärger-dich-nicht" },
                //new MessageModel { MessageId = 330, SenderId = 0, ReceiverId = 0, Date = new DateTime(2024, 6, 5, 10, 59, 34), Text = "Der Artikel Phase 10 wurde zum Katalog hinzugefügt", Type = MessageType.Unknown, Payload = "Phase 10" },
                //new MessageModel { MessageId = 331, SenderId = 0, ReceiverId = 0, Date = new DateTime(2024, 6, 5, 11, 0, 55), Text = "Der Artikel Skyjo wurde zum Katalog hinzugefügt", Type = MessageType.Unknown, Payload = "Skyjo" },
                //new MessageModel { MessageId = 332, SenderId = 0, ReceiverId = 0, Date = new DateTime(2024, 6, 5, 11, 3, 16), Text = "Der Artikel Catan wurde zum Katalog hinzugefügt", Type = MessageType.Unknown, Payload = "Catan" },
                //new MessageModel { MessageId = 333, SenderId = 0, ReceiverId = 0, Date = new DateTime(2024, 6, 5, 11, 5, 4), Text = "Der Artikel Risiko wurde zum Katalog hinzugefügt", Type = MessageType.Unknown, Payload = "Risiko" },
                //new MessageModel { MessageId = 334, SenderId = 0, ReceiverId = 0, Date = new DateTime(2024, 6, 7, 11, 30, 5), Text = "Der Artikel TestReturnItem wurde zum Katalog hinzugefügt", Type = MessageType.Unknown, Payload = "TestReturnItem" },
                //new MessageModel { MessageId = 335, SenderId = 0, ReceiverId = 3, Date = new DateTime(2024, 6, 7, 12, 17, 40), Text = "Der von Ihnen reservierte Artikel TestReturnItem ist jetzt verfügbar", Type = MessageType.ReservationAvailable, Payload = "52" },
                ...
                //new MessageModel { MessageId = 350, SenderId = 0, ReceiverId = 5, Date = new DateTime(2024, 9, 17, 6, 42, 32), Text = "user2 hat Title1Updated seit 91 Tagen überfällig", Type = MessageType.OverdueReminder, Payload = "218" },
                //new MessageModel { MessageId = 351, SenderId = 0, ReceiverId = 5, Date = new DateTime(2024, 9, 17, 6, 42, 32), Text = "user2 hat Vogue seit 96 Tagen überfällig", Type = MessageType.OverdueReminder, Payload = "220" },
                //new MessageModel { MessageId = 352, SenderId = 0, ReceiverId = 5, Date = new DateTime(2024, 9, 17, 6, 42, 32), Text = "user2 hat Supernatural Evangelium seit 96 Tagen überfällig", Type = MessageType.OverdueReminder, Payload = "221" },
                //new MessageModel { MessageId = 353, SenderId = 0, ReceiverId = 5, Date = new DateTime(2024, 9, 17, 6, 42, 32), Text = "user2 hat Title4 seit 96 Tagen überfällig", Type = MessageType.OverdueReminder, Payload = "219" },
                //new MessageModel { MessageId = 354, SenderId = 0, ReceiverId = 5, Date = new DateTime(2024, 9, 17, 6, 42, 32), Text = "user2 hat Biene Maja seit 97 Tagen überfällig", Type = MessageType.OverdueReminder, Payload = "217" },
                //new MessageModel { MessageId = 355, SenderId = 0, ReceiverId = 5, Date = new DateTime(2024, 9, 17, 6, 42, 32), Text = "user2 hat TestReservation1 seit 89 Tagen überfällig", Type = MessageType.OverdueReminder, Payload = "216" },
                //new MessageModel { MessageId = 356, SenderId = 0, ReceiverId = 0, Date = new DateTime(2024, 9, 17, 6, 43, 0), Text = "Der Artikel Das Simarillion wurde zum Katalog hinzugefügt", Type = MessageType.Unknown, Payload = "Das Simarillion" },
                ...
                //new MessageModel { MessageId = 359, SenderId = 0, ReceiverId = 25, Date = new DateTime(2024, 9, 17, 12, 24, 13), Text = "Title2 ist in 2 Tagen fällig", Type = MessageType.DueReminder, Payload = "241" },
